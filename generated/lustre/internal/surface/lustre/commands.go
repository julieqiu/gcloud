...
// Command returns the lustre command tree for inclusion under the gcloud root.
				...
				Commands: []*cli.Command{

					{
						...
						Flags: []cli.Flag{
							...
							&cli.StringFlag{Name: "order-by", Usage: "Desired order of results.", Required: false},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := lustre.NewClient(ctx, opts...)
							if err != nil {
								return err
							}
							defer client.Close()
...

					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "instance-id", Usage: "The name of the Managed Lustre instance.", Required: true},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
...

					{
						...
						Flags: []cli.Flag{
							...
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
							&cli.StringFlag{Name: "request-id", Usage: "UUID to identify requests.", Required: false},
							&cli.StringFlag{Name: "service-account", Usage: "User-specified service account used to perform the transfer.", Required: false},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/instances/%s", cmd.String("project"), cmd.String("location"), cmd.String("instance"))
							opts, err := auth.ClientOptions(ctx, cmd)
