...
// Command returns the gcloud clouddeploy command tree.
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "deliveryPipeline", Usage: "The deliveryPipeline.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/deliveryPipelines/%s", cmd.String("project"), cmd.String("location"), cmd.String("deliveryPipeline"))
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							...
							&cli.BoolFlag{Name: "validate-only", Usage: "The validate only.", Required: false},
							&cli.StringSliceFlag{Name: "override-deploy-policy", Usage: "The override deploy policy.", Required: false},
							&cli.StringFlag{Name: "description", Usage: "The description.", Required: false},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req.ValidateOnly = cmd.Bool("validate-only")
							req.OverrideDeployPolicy = cmd.StringSlice("override-deploy-policy")
