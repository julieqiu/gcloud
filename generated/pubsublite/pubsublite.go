...
// Command returns the gcloud pubsublite command tree.
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := pubsublite.NewCursorClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
							pageSize := cmd.Int("page-size")
							req := &pubsublitepb.ListPartitionCursorsRequest{Parent: parent}
							if pageSize > 0 {
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							parent := fmt.Sprintf("projects/%s/locations/%s", cmd.String("project"), cmd.String("location"))
							client, err := pubsublite.NewAdminClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							parent := fmt.Sprintf("projects/%s/locations/%s", cmd.String("project"), cmd.String("location"))
							client, err := pubsublite.NewPublisherClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							parent := fmt.Sprintf("projects/%s/locations/%s", cmd.String("project"), cmd.String("location"))
							client, err := pubsublite.NewSubscriberClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							parent := fmt.Sprintf("projects/%s/locations/%s", cmd.String("project"), cmd.String("location"))
							client, err := pubsublite.NewPartitionAssignmentClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							parent := fmt.Sprintf("projects/%s/locations/%s", cmd.String("project"), cmd.String("location"))
							client, err := pubsublite.NewTopicStatsClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.GetTopicPartitionsRequest{Name: name}
				...
				Commands: []*cli.Command{
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "reservation-id", Usage: "The reservation id.", Required: true},
							&cli.StringFlag{Name: "name", Usage: "The name.", Required: false},
							&cli.IntFlag{Name: "throughput-capacity", Usage: "The throughput capacity.", Required: false},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							parent := fmt.Sprintf("projects/%s/locations/%s", cmd.String("project"), cmd.String("location"))
							client, err := pubsublite.NewAdminClient(ctx)
							...
							defer client.Close()
							req := &pubsublitepb.CreateReservationRequest{Parent: parent}
							req.ReservationId = cmd.String("reservation-id")
							req.Reservation = &pubsublitepb.Reservation{
								Name:               cmd.String("name"),
								ThroughputCapacity: int64(cmd.Int("throughput-capacity")),
							}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.GetReservationRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							if cmd.IsSet("throughput-capacity") {
								paths = append(paths, "throughput_capacity")
							}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.DeleteReservationRequest{Name: name}
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							pageSize := cmd.Int("page-size")
							req := &pubsublitepb.ListTopicSubscriptionsRequest{Parent: parent}
							if pageSize > 0 {
								req.PageSize = int32(pageSize)
							}
							it := client.ListTopicSubscriptions(ctx, req)
							limit := cmd.Int("limit")
							count := 0
							for {
								if limit > 0 && count >= limit {
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "subscription-id", Usage: "The subscription id.", Required: true},
							&cli.BoolFlag{Name: "skip-backlog", Usage: "The skip backlog.", Required: false},
							&cli.StringFlag{Name: "name", Usage: "The name.", Required: false},
							&cli.StringFlag{Name: "topic", Usage: "The topic.", Required: false},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							parent := fmt.Sprintf("projects/%s/locations/%s", cmd.String("project"), cmd.String("location"))
							client, err := pubsublite.NewAdminClient(ctx)
							...
							defer client.Close()
							req := &pubsublitepb.CreateSubscriptionRequest{Parent: parent}
							req.SubscriptionId = cmd.String("subscription-id")
							req.SkipBacklog = cmd.Bool("skip-backlog")
							req.Subscription = &pubsublitepb.Subscription{
								Name:  cmd.String("name"),
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.GetSubscriptionRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req.UpdateMask = &fieldmaskpb.FieldMask{Paths: paths}
							resp, err := client.UpdateSubscription(ctx, req)
							if err != nil {
								return err
							}
							out, err := protojson.MarshalOptions{Multiline: true, Indent: "  "}.Marshal(resp)
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.DeleteSubscriptionRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.SeekSubscriptionRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							fmt.Println("Executing commit-cursor...")
							return nil
						},
					},
				},
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.CreateTopicRequest{Parent: parent}
							req.TopicId = cmd.String("topic-id")
							req.Topic = &pubsublitepb.Topic{
								Name: cmd.String("name"),
							}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.GetTopicRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &pubsublitepb.DeleteTopicRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							pageSize := cmd.Int("page-size")
							req := &pubsublitepb.ListReservationTopicsRequest{Parent: parent}
							if pageSize > 0 {
								req.PageSize = int32(pageSize)
							}
							it := client.ListReservationTopics(ctx, req)
							limit := cmd.Int("limit")
							count := 0
							for {
								if limit > 0 && count >= limit {
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							fmt.Println("Executing compute-message-stats...")
							return nil
						},
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							fmt.Println("Executing compute-head-cursor...")
							return nil
						},
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							fmt.Println("Executing compute-time-cursor...")
							return nil
						},
					},
				},
