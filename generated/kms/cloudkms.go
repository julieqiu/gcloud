...
// Command returns the gcloud cloudkms command tree.
				...
				Commands: []*cli.Command{
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "keyRing", Usage: "The keyRing.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/keyRings/%s", cmd.String("project"), cmd.String("location"), cmd.String("keyRing"))
