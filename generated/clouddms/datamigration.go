...
// Command returns the gcloud datamigration command tree.
		...
		Commands: []*cli.Command{
			{
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "connectionProfile", Usage: "The connectionProfile.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/connectionProfiles/%s", cmd.String("project"), cmd.String("location"), cmd.String("connectionProfile"))
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "migrationJob", Usage: "The migrationJob.", Required: true},
							&cli.StringSliceFlag{Name: "permissions", Usage: "The permissions.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/migrationJobs/%s", cmd.String("project"), cmd.String("location"), cmd.String("migrationJob"))
							client, err := clouddms.NewDataMigrationClient(ctx)
							if err != nil {
								return err
							}
