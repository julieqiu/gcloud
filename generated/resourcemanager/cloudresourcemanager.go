...
// Command returns the gcloud cloudresourcemanager command tree.
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "tagKey", Usage: "The tagKey.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("tagKeys/%s", cmd.String("tagKey"))
							client, err := resourcemanager.NewTagKeysClient(ctx)
							if err != nil {
								return err
							}
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "tagValue", Usage: "The tagValue.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("tagValues/%s", cmd.String("tagValue"))
							client, err := resourcemanager.NewTagValuesClient(ctx)
							if err != nil {
								return err
							}
