...
// Command returns the gcloud livestream command tree.
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "channel", Usage: "The channel.", Required: true},
							&cli.StringSliceFlag{Name: "distribution-keys", Usage: "The distribution keys.", Required: false},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/channels/%s", cmd.String("project"), cmd.String("location"), cmd.String("channel"))
							client, err := livestream.NewClient(ctx)
							...
							req.DistributionKeys = cmd.StringSlice("distribution-keys")
