...
import (
	...
	"cloud.google.com/go/hypercomputecluster/apiv1/hypercomputeclusterpb"
		...
		Commands: []*cli.Command{
			{
				...
				Usage: "manage Cluster Director API resources",
				Flags: []cli.Flag{
						...
						Commands: []*cli.Command{
							{
								...
								Action: func(ctx context.Context, cmd *cli.Command) error {
									...
									client, err := hypercomputecluster.NewClient(ctx)
									if err != nil {
										return err
									}
									defer client.Close()
									pageSize := cmd.Int("page-size")
									req := &hypercomputeclusterpb.ListClustersRequest{Parent: parent}
									if pageSize > 0 {
							...
							},
							{
								...
								Action: func(ctx context.Context, cmd *cli.Command) error {
									...
									defer client.Close()
									req := &hypercomputeclusterpb.GetClusterRequest{Name: name}
							...
							},
							{
								...
								Action: func(ctx context.Context, cmd *cli.Command) error {
									...
									defer client.Close()
									req := &hypercomputeclusterpb.CreateClusterRequest{Parent: parent}
									req.ClusterId = cmd.String("cluster-id")
									req.Cluster = &hypercomputeclusterpb.Cluster{
							...
							},
							{
								...
								Action: func(ctx context.Context, cmd *cli.Command) error {
									...
									defer client.Close()
									req := &hypercomputeclusterpb.DeleteClusterRequest{Name: name}
