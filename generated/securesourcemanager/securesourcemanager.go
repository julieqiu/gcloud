...
// Command returns the gcloud securesourcemanager command tree.
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							fmt.Printf("Executing get-iam-policy-repo on %s\n", name)
							return nil
						},
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/repositories/%s", cmd.String("project"), cmd.String("location"), cmd.String("repositorie"))
							fmt.Printf("Executing set-iam-policy-repo on %s\n", name)
							return nil
						},
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/repositories/%s", cmd.String("project"), cmd.String("location"), cmd.String("repositorie"))
							fmt.Printf("Executing test-iam-permissions-repo on %s\n", name)
							return nil
						},
					},
					{
