		...
		Commands: []*cli.Command{
			{
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/appConnections/%s", cmd.String("project"), cmd.String("location"), cmd.String("appConnection"))
							client, err := appconnectors.NewClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req := &appconnectorspb.ListAppConnectorsRequest{Parent: parent}
							if pageSize > 0 {
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "app_connector", Usage: "The app_connector.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/appConnectors/%s", cmd.String("project"), cmd.String("location"), cmd.String("app_connector"))
							client, err := appconnectors.NewClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
							req := &appconnectorspb.GetAppConnectorRequest{Name: name}
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "app-connector-id", Usage: "The app connector id.", Required: false},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &appconnectorspb.CreateAppConnectorRequest{Parent: parent}
							req.AppConnectorId = cmd.String("app-connector-id")
							req.ValidateOnly = cmd.Bool("validate-only")
							req.AppConnector = &appconnectorspb.AppConnector{
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							op, err := client.UpdateAppConnector(ctx, req)
							if err != nil {
								return err
							}
							resp, err := op.Wait(ctx)
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &appconnectorspb.DeleteAppConnectorRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							fmt.Println("Executing report-status...")
							return nil
						},
					},
				},
