...
// Command returns the notebooks command tree for inclusion under the gcloud root.
				...
				Commands: []*cli.Command{

					{
						...
						Flags: []cli.Flag{
							...
							&cli.IntFlag{Name: "page-size", Usage: "Maximum return size of the list call.", Required: false},
							&cli.StringFlag{Name: "page-token", Usage: "A previous returned page token that can be used to continue.", Required: false},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := notebooks.NewClient(ctx, opts...)
							if err != nil {
								return err
							}
							defer client.Close()
...

					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "instance-id", Usage: "User-defined unique ID of this instance.", Required: true},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
...

					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "instance", Usage: "The ID of the instance.", Required: true},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "notebook-instance", Usage: "Format:.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							notebook_instance := fmt.Sprintf("projects/%s/locations/%s/instances/%s", cmd.String("project"), cmd.String("location"), cmd.String("instance"))
							fmt.Printf("Executing check-upgradability on %s\n", notebook_instance)
							return nil
						},
					},
...

					{
						...
						Flags: []cli.Flag{
							...
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
							&cli.StringFlag{Name: "revision-id", Usage: "Revision Id.", Required: true},
							&cli.StringFlag{Name: "target-snapshot", Usage: "The snapshot for rollback.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/instances/%s", cmd.String("project"), cmd.String("location"), cmd.String("instance"))
							opts, err := auth.ClientOptions(ctx, cmd)
							...
							req := &notebookspb.RollbackInstanceRequest{
								Name:           name,
								TargetSnapshot: cmd.String("target-snapshot"),
...

					{
						...
						Flags: []cli.Flag{
							...
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
							&cli.IntFlag{Name: "timeout-minutes", Usage: "Maxmium amount of time in minutes before the operation times out.", Required: false},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/instances/%s", cmd.String("project"), cmd.String("location"), cmd.String("instance"))
							opts, err := auth.ClientOptions(ctx, cmd)
							...
							req := &notebookspb.DiagnoseInstanceRequest{
								Name:           name,
								TimeoutMinutes: int32(cmd.Int("timeout-minutes")),
							}
