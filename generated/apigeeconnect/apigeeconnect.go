...
// Command returns the gcloud apigeeconnect command tree.
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := apigeeconnect.NewConnectionClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
							pageSize := cmd.Int("page-size")
							req := &apigeeconnectpb.ListConnectionsRequest{Parent: parent}
							if pageSize > 0 {
