...
// Command returns the gcloud storagebatchoperations command tree.
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := storagebatchoperations.NewClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
							pageSize := cmd.Int("page-size")
							req := &storagebatchoperationspb.ListBucketOperationsRequest{Parent: parent}
							if pageSize > 0 {
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "job", Usage: "The job.", Required: true},
							&cli.StringFlag{Name: "bucket_operation", Usage: "The bucket_operation.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/jobs/%s/bucketOperations/%s", cmd.String("project"), cmd.String("location"), cmd.String("job"), cmd.String("bucket_operation"))
							client, err := storagebatchoperations.NewClient(ctx)
							if err != nil {
								return err
							}
							defer client.Close()
							req := &storagebatchoperationspb.GetBucketOperationRequest{Name: name}
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							pageSize := cmd.Int("page-size")
							req := &storagebatchoperationspb.ListJobsRequest{Parent: parent}
							if pageSize > 0 {
								req.PageSize = int32(pageSize)
							}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &storagebatchoperationspb.GetJobRequest{Name: name}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &storagebatchoperationspb.CreateJobRequest{Parent: parent}
							req.JobId = cmd.String("job-id")
							req.Job = &storagebatchoperationspb.Job{
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &storagebatchoperationspb.DeleteJobRequest{Name: name}
