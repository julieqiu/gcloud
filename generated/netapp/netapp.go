...
// Command returns the gcloud netapp command tree.
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							...
							&cli.StringSliceFlag{Name: "peer-ip-addresses", Usage: "The peer ip addresses.", Required: false},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req.PeerIpAddresses = cmd.StringSlice("peer-ip-addresses")
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							...
							&cli.StringFlag{Name: "volume", Usage: "The volume.", Required: true},
							&cli.StringFlag{Name: "backup", Usage: "The backup.", Required: true},
							&cli.StringSliceFlag{Name: "file-list", Usage: "The file list.", Required: true},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req.FileList = cmd.StringSlice("file-list")
