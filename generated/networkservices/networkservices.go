...
// Command returns the gcloud networkservices command tree.
				...
				Commands: []*cli.Command{
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "edgeCacheKeyset", Usage: "The edgeCacheKeyset.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/edgeCacheKeysets/%s", cmd.String("project"), cmd.String("location"), cmd.String("edgeCacheKeyset"))
