...
// Command returns the gcloud workflows command tree.
func Command() *cli.Command {
	return &cli.Command{
		Name:  "workflows",
		Usage: "manage Workflows API resources",
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &workflowspb.GetWorkflowRequest{Name: name}
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "workflow-id", Usage: "The workflow id.", Required: true},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &workflowspb.CreateWorkflowRequest{Parent: parent}
							req.WorkflowId = cmd.String("workflow-id")
							req.Workflow = &workflowspb.Workflow{
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							req := &workflowspb.DeleteWorkflowRequest{Name: name}
							op, err := client.DeleteWorkflow(ctx, req)
							if err != nil {
								return err
							}
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							op, err := client.UpdateWorkflow(ctx, req)
							if err != nil {
								return err
							}
							resp, err := op.Wait(ctx)
					...
					},
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							defer client.Close()
							pageSize := cmd.Int("page-size")
							req := &workflowspb.ListWorkflowRevisionsRequest{Parent: parent}
							if pageSize > 0 {
								req.PageSize = int32(pageSize)
							}
							it := client.ListWorkflowRevisions(ctx, req)
							limit := cmd.Int("limit")
							count := 0
							for {
								if limit > 0 && count >= limit {
