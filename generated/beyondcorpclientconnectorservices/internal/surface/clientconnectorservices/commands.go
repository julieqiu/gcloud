...
import (
	clientconnectorservices "cloud.google.com/go/clientconnectorservices/apiv1"
	"cloud.google.com/go/clientconnectorservices/apiv1/clientconnectorservicespb"
	"context"
	"errors"
	"fmt"
				...
				Commands: []*cli.Command{

					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := clientconnectorservices.NewClient(ctx, opts...)
							if err != nil {
								return err
							}
							defer client.Close()
...

					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "client-connector-service", Usage: "The ID of the client connector service.", Required: true},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/clientConnectorServices/%s", cmd.String("project"), cmd.String("location"), cmd.String("client-connector-service"))
							opts, err := auth.ClientOptions(ctx, cmd)
							if err != nil {
								return err
							}
...

					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "client-connector-service-id", Usage: "User-settable client connector service resource ID.", Required: false},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req := &clientconnectorservicespb.CreateClientConnectorServiceRequest{
								Parent:                   parent,
								ClientConnectorServiceId: cmd.String("client-connector-service-id"),
...

					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							// TODO: nested path field "client_connector_service.name" not yet supported.
							client_connector_service_name := fmt.Sprintf("projects/%s/locations/%s/clientConnectorServices/%s", cmd.String("project"), cmd.String("location"), cmd.String("client-connector-service"))
							fmt.Printf("Executing update on %s\n", client_connector_service_name)
							return nil
						},
					},

					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/clientConnectorServices/%s", cmd.String("project"), cmd.String("location"), cmd.String("client-connector-service"))
							if !cmd.Bool("quiet") {
								if err := runtime.Confirm(fmt.Sprintf("DeleteClientConnectorService %s?", name)); err != nil {
									return err
								}
							}
							opts, err := auth.ClientOptions(ctx, cmd)
