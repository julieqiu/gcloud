...
// Command returns the gcloud dataproc command tree.
				...
				Commands: []*cli.Command{
					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/regions/%s/clusters/%s", cmd.String("project"), cmd.String("region"), cmd.String("cluster"))
