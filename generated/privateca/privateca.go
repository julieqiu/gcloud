...
// Command returns the gcloud privateca command tree.
		...
		Commands: []*cli.Command{
			{
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "location", Usage: "The location.", Required: true},
							&cli.StringFlag{Name: "caPool", Usage: "The caPool.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/caPools/%s", cmd.String("project"), cmd.String("location"), cmd.String("caPool"))
