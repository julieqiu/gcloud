...
import (
	clientgateways "cloud.google.com/go/clientgateways/apiv1"
	"cloud.google.com/go/clientgateways/apiv1/clientgatewayspb"
	"context"
	"errors"
	"fmt"
				...
				Commands: []*cli.Command{

					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := clientgateways.NewClient(ctx, opts...)
							if err != nil {
								return err
							}
							defer client.Close()
...

					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "client-gateway", Usage: "The ID of the client gateway.", Required: true},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
						},
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/clientGateways/%s", cmd.String("project"), cmd.String("location"), cmd.String("client-gateway"))
							opts, err := auth.ClientOptions(ctx, cmd)
							if err != nil {
								return err
							}
...

					{
						...
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "client-gateway-id", Usage: "User-settable client gateway resource ID.", Required: false},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req := &clientgatewayspb.CreateClientGatewayRequest{
								Parent:          parent,
								ClientGatewayId: cmd.String("client-gateway-id"),
...

					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							name := fmt.Sprintf("projects/%s/locations/%s/clientGateways/%s", cmd.String("project"), cmd.String("location"), cmd.String("client-gateway"))
							if !cmd.Bool("quiet") {
								if err := runtime.Confirm(fmt.Sprintf("DeleteClientGateway %s?", name)); err != nil {
									return err
								}
							}
							opts, err := auth.ClientOptions(ctx, cmd)
