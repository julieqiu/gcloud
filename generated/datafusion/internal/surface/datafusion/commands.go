...
// Command returns the datafusion command tree for inclusion under the gcloud root.
				...
				Commands: []*cli.Command{

					{
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							client, err := datafusion.NewClient(ctx, opts...)
							if err != nil {
								return err
							}
							defer client.Close()
			...
			},
			{
				...
				Commands: []*cli.Command{

					{
						...
						Usage: "list versions",
						Flags: []cli.Flag{
							&cli.BoolFlag{Name: "latest-patch-only", Usage: "Whether or not to return the latest patch of every available minor version.", Required: false},
							&cli.StringFlag{Name: "location", Usage: "The Cloud location for the resource.", Required: true},
							&cli.IntFlag{Name: "page-size", Usage: "The maximum number of items to return.", Required: false},
							&cli.StringFlag{Name: "page-token", Usage: "The next_page_token value to use if there are additional.", Required: false},
							&cli.StringFlag{Name: "project", Usage: "The Cloud project for the resource.", Required: true},
						...
						Action: func(ctx context.Context, cmd *cli.Command) error {
							...
							req := &datafusionpb.ListAvailableVersionsRequest{
								...
								PageSize:        int32(cmd.Int("page-size")),
								PageToken:       cmd.String("page-token"),
								LatestPatchOnly: cmd.Bool("latest-patch-only"),
							}

							limit := cmd.Int("limit")
							it := client.ListAvailableVersions(ctx, req)
							count := 0
							for {
								resp, err := it.Next()
								if errors.Is(err, iterator.Done) {
